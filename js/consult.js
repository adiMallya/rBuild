function allLetter()
{    
var uname = document.consultform.name;    
var letter = /^[A-Za-z +]+$/;
if(uname.value.match(letter))
{
    setSuccesFor(uname);
    document.consultform.phno.focus();
    return true; 
}
else
{
...
{ 
var num = document.consultform.phno;    
var phonenos = /^\d{10}$/;
if(num.value.match(phonenos))
{
    setSuccesFor(num);    
    document.consultform.mail.focus();  
    return true;
}
else
{
...
{
var email = document.consultform.mail;    
...
function onSubmission(){
    ...
    if (n.value == false || p.value == false || e.value ==false){
        ...
        const frm = document.getElementById("form4");
